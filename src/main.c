...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/14 19:23:53 by ikarouat          #+#    #+#             */
/*   Updated: 2026/01/15 15:53:39 by ikarouat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	{
		print_usage();
		return (cleanup_engine(&engine), EXIT_FAILURE);
	}
	...
	(mlx_loop(engine.mlx->mlx), cleanup_engine(&engine));
	return (EXIT_SUCCESS);
}
